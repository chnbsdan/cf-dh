  ...
  <div class="modal-content modal-content-wide">
    ...
    <div style="max-height:70vh;overflow-y:auto;padding:0.5rem 0;">
      ...
      <div style="margin-bottom:1.5rem;background:rgba(239,68,68,0.05);border:1px solid rgba(239,68,68,0.10);border-radius:12px;padding:1.2rem;">
        ...
        <div style="color:#475569;line-height:1.8;font-size:0.95rem;">
          <p style="background:rgba(239,68,68,0.06);padding:0.8rem 1rem;border-radius:8px;border-left:4px solid #ef4444;color:#1e293b;font-weight:500;">chnbsdan@gmail.com</p>
          <p style="margin-top:0.5rem;color:#475569;font-weight:400;">或留言：<a href="https://aoso.hangdn.com/guestbook" target="_blank" style="color:#6366f1;text-decoration:none;border-bottom:1px dashed #6366f1;font-weight:500;">https://aoso.hangdn.com/guestbook</a></p>
        </div>
      </div>
